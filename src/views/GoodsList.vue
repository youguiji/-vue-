 ...
 * @Version: 
 * @Autor: Austral
 * @Date: 2022-11-18 21:46:43
 * @LastEditors: Austral
 * @LastEditTime: 2022-11-19 09:12:51
-->
<template>
            ...
            <el-table-column label="操作" align="center" width="210">
              <template #default="scope">
                <el-button
                  size="small"
                  round
                  @click="qryGoodsInfo(scope.row.goodsId)"
                  >查看</el-button
                >
                <el-button
                  type="success"
                  ...
                  @click="updGoodsStatus(scope.row.goodsId, scope.row.status)"
                  >上架</el-button
                >
                <el-button
                  type="info"
                ...
                <el-button
                  ...
                  size="small"
                  round
                  @click="updGoodsInfo(scope.row.goodsId)"
                  >编辑</el-button
                >
                <el-button
                  type="danger"
                  size="small"
                  round
                  @click="delGoodsInfo(scope.row.goodsId)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
  ...
  setup() {
    ...
    const init = () => {
      ...
      state.tableData = [
        {
          goodsId: "10001",
          goodsName: "饼干-案件韩国大受打击会是大分公司丢案发把速度告发送",
          coverImg: require("@/assets/image/logo.png"),
          stock: "1000",
          goodsPrice: "12.58",
          categoryName: "食品",
          status: "1",
          updateTime: "2016-05-02 12:20:21",
        },
        {
          goodsId: "10001",
          goodsName: "饼干",
    ...
    const qryGoodsInfo = (goodsId) => {
      router.push({
        path: "goods-add",
        query: { goodsId: goodsId, type: "query" },
      });
      console.log(goodsId);
    };
    // 添加
    ...
    const updGoodsInfo = (goodsId) => {
      router.push({
        path: "goods-add",
        query: { goodsId: goodsId, type: "edit" },
      });
      console.log(goodsId);
    };
